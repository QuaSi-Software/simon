...
# apt package xvfb
DISPLAY=:0 xvfb-run -s '-screen 0 1024x768x24' julia --threads=$SIM_NR_THREADS -e 'using Pkg; Pkg.activate("."); Pkg.develop(Pkg.PackageSpec(; path="./resie/")); Pkg.add(["Dates", "JSON", "Printf", "UUIDs"]);'
